...
public class ClienteDaoImpl implements ClienteDao{
	...
	public List<Cliente> carregarTodosClientes(
		...
		//Verificar se o relacionamento com Pedidos deverá ser carregado (JOIN realizado). Isso pois a relação é LAZY e não será carregada automaticamente
		if (recuperarPedidos) {
	...
	public Cliente salvarCliente(Cliente cliente) throws RegistroJaExisteException{
		//Valida campos únicos (se já não existe cliente com campos únicos desse registro)
	...
	//Indica que o método é implementação de uma interface
	@Override
	//Método que verifica se já não existe um cliente com os campos únicos recuperados
